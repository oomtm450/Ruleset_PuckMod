...
namespace oomtm450PuckMod_Ruleset {
    internal static class PenaltyModule {
        ...
        private static readonly Vector3 BLUE_PENALTY_BOX_POSITION = new Vector3(26f, 1f, 3f);
        ...
        internal static readonly Vector3 DELAY_OF_GAME_POSITION = new Vector3(24f, 0f, (float)ZoneFunc.ICE_Z_POSITIONS[IceElement.BlueTeam_BlueLine].End + 7f);
